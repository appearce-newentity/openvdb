...
/// @file Geometry.cc
/// @brief Out-of-line implementation of vdb_tool::Geometry (see Geometry.h).

#include "Geometry.h"

#ifdef VDB_TOOL_USE_GLTF
// tinygltf implementation lives in this TU (and only this TU). No images are
// loaded by vdb_tool, so disable the bundled stb_image / stb_image_write paths.
